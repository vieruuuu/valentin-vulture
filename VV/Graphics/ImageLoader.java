...
public class ImageLoader {
   ...
   * \brief Incarca o imagine intr-un obiect BufferedImage si returneaza o
   * referinta catre acesta.
   * 
   * \param path Calea relativa pentru localizarea fisierul imagine.
   */
  public static BufferedImage LoadImage(String path) {
    /// Avand in vedere exista situatii in care fisierul sursa sa nu poate fi
    /// accesat
    ...
    try {
      ...
      /// directorul res, director declarat ca director de resurse in care se gasesc
      /// resursele
