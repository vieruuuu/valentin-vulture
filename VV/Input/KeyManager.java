...
public class KeyManager implements KeyListener {
  private boolean[] keys; /*
                           * !< Vector de flaguri pentru toate tastele. Tastele vor fi regasite dupa cod
                           * [0 - 255]
                           */
  ...
  public boolean action; /* !< Flag pentru tasta "space" apasata. */
   ...
   * \brief Functie ce va fi apelata atunci cand un un eveniment de tasta apasata
   * este generat.
   * 
   ...
   * \brief Functie ce va fi apelata atunci cand un un eveniment de tasta
   * eliberata este generat.
   * 
   * \param e obiectul eveniment de tastatura.
   */
  @Override
   ...
   * \brief Functie ce va fi apelata atunci cand o tasta a fost apasata si
   * eliberata.
