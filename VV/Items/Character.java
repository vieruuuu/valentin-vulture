...
public abstract class Character extends Item {
  ...
  /*
   * ! \fn public Character(RefLinks refLink, float x, float y, int width, int
   * height)
   * \brief Constructor de initializare al clasei Character
   * 
   * \param refLink Referinta catre obiectul shortcut (care retine alte referinte
   * utile/necesare in joc).
   ...
   */
  public void MoveX() {
    /// Aduna la pozitia curenta numarul de pixeli cu care trebuie sa se deplaseze
    /// pe axa X.
    x += xMove;
  }
