...
public abstract class Item {
  /// asa cum s-a mai precizat, coordonatele x si y sunt de tip float pentru a se
  /// elimina erorile de rotunjire
  /// ce pot sa apara in urma calculelor, urmand a se converti la intreg doar in
  /// momentul desenarii.
  ...
  protected Rectangle normalBounds; /*
                                     * !< Dreptunghiul de coliziune aferent starii obisnuite(spatiul ocupat de
                                     * entitate in mod normal), poate fi mai mic sau mai mare decat dimensiunea
                                     * imaginii sale.
                                     */
  ...
  public Item(RefLinks refLink, float x, float y, int width, int height) {
    ...
    /// Creaza dreptunghi de coliziune pentru modul de atack, aici a fost stabilit
    /// la dimensiunea imaginii dar poate fi orice alta dimensiune
