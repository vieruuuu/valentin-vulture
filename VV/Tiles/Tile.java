...
public class Tile {
  ...
  /// De remarcat ca urmatoarele dale sunt statice si publice. Acest lucru imi
  /// permite sa le am incarcate
  /// o singura data in memorie
  public static Tile floorTile = new FloorTile(0); /* !< Dala de tip apa */
  public static Tile wallTile = new WallTile(1); /* !< Dala de tip apa */
