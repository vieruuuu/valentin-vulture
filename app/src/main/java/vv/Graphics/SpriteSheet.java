...
public class SpriteSheet {
  ...
  public BufferedImage crop(int x, int y) {
    /// Subimaginea (dala) este regasita in sprite sheet specificad coltul stanga
    /// sus
    /// al imaginii si apoi latimea si inaltimea (totul in pixeli). Coltul din
    /// stanga sus al imaginii
    /// se obtine inmultind numarul de ordine al dalei cu dimensiunea in pixeli a
    /// unei dale.
